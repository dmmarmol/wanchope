...
include_once "src/php/my-functions.php";
...
function cd_meta_box_add() {
	add_meta_box( 'post-audio-url', __('Post format audio URL', 'lingonberry'), 'cd_meta_box_audiourl', 'post', 'side', 'high' );
	add_meta_box( 'post-video-url', __('Post format video URL', 'lingonberry'), 'cd_meta_box_videourl', 'post', 'side', 'high' );
}

function cd_meta_box_audiourl( $post ) {
...
function cd_meta_box_videourl( $post ) {
	$values = get_post_custom( $post->ID );
